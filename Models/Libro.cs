...
namespace Libreria.Models
{
    public class Libro
    {
        ...
        [RegularExpression(@"^[a-zA-Z0-9]*$", ErrorMessage = "Teienes sibolos no permitidos")]
        ...
        [RegularExpression(@"^[a-zA-Z0-9]*$", ErrorMessage = "Tienes sibolos no permitidos")]
        ...
        [RegularExpression(@"^[a-zA-Z]*$", ErrorMessage = "No recibimos numeros" )]
